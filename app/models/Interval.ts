...
import { IExchangeType, ExchangeType } from "./ExchangeType"
...
export class Interval extends Model<IInterval> {
	...
	public exchangeType(): BelongsTo<IExchangeType, ExchangeType> {
		return this.belongsTo<ExchangeType>(ExchangeType.TAG, ExchangeType.prototype, this.fields.fk_exchange_types)
	}
